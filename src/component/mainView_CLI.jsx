...
function MainViewCLI({
  ...
  const [extractedLanguage, setExtractedLanguage] = useState("");
  ...
  const MessageBubbleInner = ({
    ...
    console.log(text, "tettxttxttxttx");
    console.log(promptEnggType, "promptEnggType-=-=-");
  ...
  const fetchMessageHistory = async (start, end) => {
    ...
    console.log(messages, "messages0000000");
  ...
  firstInput = firstInput.join(delimiter).trim();
  firstInput = firstInput.split(delimiter);
  language = firstInput[0].replace("#", "").replace("-", " ");

  // if (firstInput) {
  //   firstInput = firstInput.split(delimiter);
  //   console.log(firstInput, "firstInputifffff");

  //   if (firstInput.length > 0) {
  //     console.log(language, "language-=-=-2332");
  //     setExtractedLanguage(language);
  //   } else {
  //     setExtractedLanguage(firstInput[0].replace("#", "").replace("-", " "));
  //   }
  // }
  ...
  const handleSubmit = async (e) => {
    ...
    // if(!language){
    //   console.warn("Language extraction failed")
    // }
    ...
    console.log(phases, "phases1212-=-=-=");
    // console.log(programmingLanguage,'programmingLanguage121-=-')

    // setProgramingLanguage(language);
    ...
    console.log(extractedLanguage, "extractedLanguage0-0-0");
    const data = {
      llm,
      model,
                        ...
                        <>
                          ...
                          >
                            {replyText
                              ...
                              .replace(/@/g, "")
                              .trim()}
                            {console.log(replyText, "replyText-=-=11")}
                          </label>
                          <IoCloseSharp
                            data-tooltip-id="my-tooltip"
