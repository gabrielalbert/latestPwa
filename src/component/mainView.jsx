...
function MainView({ active, llmmodel, llm,llmkey,breadcrumb,headertext }) {
  ...
  const MessageBubbleInner = ({ id, text, sender, time, feedback, chatid ,promptEnggType}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (replyText) {
      ...
      if (promptCommand.length == 0) {
        setError('Please enter # for Programming language, @ for Phase and prompt or / for convert serial wise');
        return;
      } else {
        setError('');
      }
                ...
                <div className="container">
                  <div className="row" style={{ marginTop: "-20px" }}>
                    ...
                    <div className="col-7" style={{ marginTop: "-50px" }}>
                      {replyText ? <>
                        ...
                        <IoCloseSharp
                            ...
                            style={{ cursor: "pointer", float: "right", marginTop: "3px", marginRight: "10px" }}
                          />
                      </>
                        : ''}
                    </div>
                    <div className="col-3">
                      ...
                      />
                      {selectVisible ? (
                        <select classname="form-select" onChange={handleSelectChange} aria-label="Default select example" style={{ marginLeft: "5px", transform: "translateY(-120%)", width: "70%", float: "right" }}>
